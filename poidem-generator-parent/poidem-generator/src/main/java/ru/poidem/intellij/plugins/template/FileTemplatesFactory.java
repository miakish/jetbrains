...
public class FileTemplatesFactory implements FileTemplateGroupDescriptorFactory {
  ...
  public FileTemplateGroupDescriptor getFileTemplatesDescriptor() {
    ...
    descriptor.addTemplate(new FileTemplateDescriptor("PG_Dto.java", AllIcons.Nodes.Class));
    descriptor.addTemplate(new FileTemplateDescriptor("PG_Entity.java", AllIcons.Nodes.Class));

    descriptor.addTemplate(new FileTemplateDescriptor("PG_Enum.java", AllIcons.Nodes.Enum));
    descriptor.addTemplate(new FileTemplateDescriptor("PG_EnumConverterInteger.java", AllIcons.Nodes.Class));
    descriptor.addTemplate(new FileTemplateDescriptor("PG_EnumConverterLong.java", AllIcons.Nodes.Class));
    descriptor.addTemplate(new FileTemplateDescriptor("PG_EnumConverterString.java", AllIcons.Nodes.Class));
    descriptor.addTemplate(new FileTemplateDescriptor("PG_Interface.java", AllIcons.Nodes.Interface));
    descriptor.addTemplate(new FileTemplateDescriptor("PG_Job.java", AllIcons.Nodes.Class));
